...
const ENUM_MAPS = {
  ...
  "asset_group.primary_status": reverse(enums.AssetGroupPrimaryStatus),
  "asset_group.primary_status_reasons": reverse(enums.AssetGroupPrimaryStatusReason),
  "asset_group.ad_strength": reverse(enums.AdStrength),
  "asset_group_asset.performance_label": reverse(enums.AssetPerformanceLabel),
  "asset_group_asset.field_type": reverse(enums.ServedAssetFieldType),
