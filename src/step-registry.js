...
const { storeConversionActionsCfg } = require("./store-conversion-actions-cfg");
...
const STEPS = {
  ...
  storeConversionActionsCfg: withTraits(
    (rows, cfg, ctx) => storeConversionActionsCfg(rows, cfg, ctx),
    { phase: "post", changesCardinality: false }
  ),
